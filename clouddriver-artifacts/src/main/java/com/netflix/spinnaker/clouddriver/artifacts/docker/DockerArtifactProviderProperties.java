...
public class DockerArtifactProviderProperties implements ArtifactProvider<DockerArtifactAccount> {
  private boolean enabled;
  private List<DockerArtifactAccount> accounts = new ArrayList<>();
}
